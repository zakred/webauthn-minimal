...
const CLIENT_SECRET =
    process.env.CLIENT_SECRET || "ywbDEJDPuQFfhtocdArLIkTex18a";
const REDIRECT_CALLBACK_FQDN =
    process.env.CALLBACK_FQDN || "http://localhost:3000/callback";
...
const wso2Service = new Wso2Service(
    WSO2_FQDN,
    REDIRECT_CALLBACK_FQDN,
    CLIENT_ID,
    CLIENT_SECRET,
);
...
router.post(
    "/login/webauthn/signed-challenge",
    asyncHandler(async (req, res) => {
        try {
